...
const carouselWebp = '/media/Projects/3DCharacterCarousel.webp';
...
export const otherProjects = [
  ...
  {
    id: 4,
    name: '3D Character Carousel',
    slug: '3d-character-carousel',
    stack: [],
    description: '',
    image: carouselWebp,
    categories: ['Showcase'],
    demoLink: 'https://mrarindam.github.io/3D-Collactable-Hero/',
    githubLink: 'https://github.com/mrarindam/3D-Collactable-Hero',
    prompt: `Build a single full-viewport hero section in React + TypeScript + Vite + Tailwind CSS, using \`lucide-react\` for icons. The component is a character-figurine carousel called "Arindam".
...
3. Top-left brand label "Arindam" (absolute top-6 left-4 sm:left-8, zIndex 60): text-xs font-semibold uppercase, white, opacity 0.9, letterSpacing 0.18em.
